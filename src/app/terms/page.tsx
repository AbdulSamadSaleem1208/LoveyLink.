            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
                ...
                <section>
                    ...
                    <p className="text-gray-300 leading-relaxed mb-4">
                        ...
                        Permission is granted to temporarily download one copy of the materials (information or software) on LoveyLink's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                    </p>
                    <ul className="list-disc list-inside text-gray-400 space-y-2 ml-4">
                        <li>modify or copy the materials;</li>
                        <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
                        <li>attempt to decompile or reverse engineer any software contained on LoveyLink's website;</li>
                ...
                <section>
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        You retain ownership of any content (text, images, music) you upload to LoveyLink. However, by uploading content, you grant LoveyLink a license to host, store, and display your content as necessary to provide the service. You are solely responsible for the content you upload and must ensure you have the necessary rights to use it.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        In no event shall LoveyLink or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on LoveyLink's website.
                    </p>
                </section>
